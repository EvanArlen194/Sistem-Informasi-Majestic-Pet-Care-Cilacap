...
if(empty($_SESSION["keranjang_layanan"]) OR !isset($_SESSION["keranjang_layanan"]))
{
...
<html lang="en">
  <head>
    <title>Majestic Pet Care - Keranjang</title>
    ...
    <section class="kontent">
        <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php $nomor=1; ?>
                    <?php foreach ($_SESSION["keranjang_layanan"] as $id_layanan => $item):?> 
                    <?php
                    $ambil = $koneksi->query("SELECT * FROM layanan WHERE id_layanan='$id_layanan'");
                    $pecah = $ambil->fetch_assoc();
                    $subharga = $pecah["harga_layanan"] * $item["jumlah"];
                    ?>
                    <tr>
                        ...
                        <td>
                            <a href="hapuskeranjang_layanan.php?id=<?php echo $id_layanan ?>" class="btn btn-danger btn-xs">Hapus</a>
                        </td>
                    </tr>
                    <?php $nomor++; ?>
                    <?php endforeach ?>
            ...
            <a href="services.php" class="btn btn-default">Lanjutkan Belanja</a>
            <a href="checkout_layanan.php" class="btn btn-primary">Checkout</a>    
        </div> 
    </section>
