...
// Query untuk mengambil data nama layanan dan jumlah pembelian yang sudah lunas
$sql = "SELECT nama, SUM(jumlah) as total_jumlah FROM pembelian_layanan
        WHERE id_pembelian IN (SELECT id_pembelian FROM pembelian_layanan_layanan WHERE status_pembayaran = 'Lunas')
        GROUP BY nama";
...
<head>
  ...
  <title>Pemilik - Pemesanan Layanan</title>
