...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['bukti_pembayaran'])) {
    ...
    $query = "UPDATE pembelian_layanan_layanan SET bukti_pembayaran = ? WHERE id_pembelian = ?";
   ...
   <section class="kontent">
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php $nomor=1; ?>
                <?php $ambil = $koneksi->query("SELECT * FROM pembelian_layanan 
        JOIN layanan ON pembelian_layanan.id_layanan = layanan.id_layanan
        WHERE pembelian_layanan.id_pembelian='$_GET[id]'"); ?>
                <?php while($pecah=$ambil->fetch_assoc()){ ?>
                    <tr>
                        <td><?php echo $nomor; ?></td>
                        <td><?php echo $pecah['nama_layanan'];?></td>
                        <td><?php echo $pecah['harga_layanan'];?></td>
                        <td><?php echo $pecah['jumlah'];?></td>
                        <td><?php echo $pecah['waktu'];?></td>
                        <td>
                            <?php echo $pecah['harga_layanan']*$pecah['jumlah']; ?>
                        </td>
                    </tr>
                    <?php $nomor++; ?>
                <?php } ?>
