...
if (isset($_GET['id'])) {
  ...
  $get_status = $koneksi->query("SELECT status_pembayaran FROM pembelian_layanan_layanan WHERE id_pembelian=$id_pembelian");
  ...
  // Update the status
  $update_status = $koneksi->query("UPDATE pembelian_layanan_layanan SET status_pembayaran='$new_status' WHERE id_pembelian=$id_pembelian");
