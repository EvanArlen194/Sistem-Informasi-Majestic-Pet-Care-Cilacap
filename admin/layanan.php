...
<div class="min-height-300 bg-white position-absolute w-100"></div>
  ...
  <section class="py-4">
    <div class="container-fluid">
                    ...
                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <img src="../foto_layanan/<?php echo $pecah['foto_layanan']; ?>" width="100">
                            </td>
                            <td class="text-center">
                            <a href="hapuslayanan.php?id=<?php echo $pecah['id_layanan']; ?>" class="btn btn-bahaya">Hapus</a>
                            <a href="ubahlayanan.php?id=<?php echo $pecah['id_layanan']; ?>" class="btn btn-awas">Ubah</a>
                            </td>
                        </tr>
                        <?php $nomor++; ?>
                    <?php } ?>
        ...
        <a href="tambahlayanan.php" class="btn btn-green">Tambah</a>
    </div>
</section>
