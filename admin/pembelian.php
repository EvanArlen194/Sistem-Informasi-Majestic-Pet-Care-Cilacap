  ...
  <main class="main-content position-relative border-radius-lg">
    <section class="py-4">
      <div class="container-fluid">
        <h3 class="mb-4">Data Pembelian Produk</h3>
              ...
              <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="detail.php?id=<?php echo $pecah['id_pembelian']; ?>" class="btn btn-inpo">Detail</a>
                    <a href="update_status.php?id=<?php echo $pecah['id_pembelian']; ?>" class="btn btn-green">Status</a>
                  </td>
                </tr>
                <?php $nomor++; ?>
              <?php } ?>
