...
<div class="min-height-300 bg-white position-absolute w-100"></div>
  ...
  <section class="py-4">
    <div class="container-fluid">
                ...
                <tbody>
                    ...
                    <?php while ($pecah = $ambil->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $pecah['berat_produk']; ?></td>
                            <td class="text-center">
                                <img src="../foto_produk/<?php echo $pecah['foto_produk']; ?>" width="100">
                            </td>
                            <td class="text-center">
                            <a href="hapusproduk.php?id=<?php echo $pecah['id_produk']; ?>" class="btn btn-bahaya">Hapus</a>
                            <a href="ubahproduk.php?id=<?php echo $pecah['id_produk']; ?>" class="btn btn-awas">Ubah</a>
        ...
        <a href="tambahproduk.php" class="btn btn-green">Tambah</a>
    </div>
</section>
