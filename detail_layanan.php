...
if (isset($_POST["beli"])) {
    if (empty($_POST["jumlah"]) || $_POST["jumlah"] <= 0) {
        ...
        echo "<script>location = 'detail_layanan.php?id=$id_layanan';</script>"; // Redirect back to detail_layanan.php
        exit;
    } else {
        $jumlah = $_POST["jumlah"];
        $waktu = $_POST["waktu"];
        $_SESSION["keranjang_layanan"][$id_layanan] = array(
            "jumlah" => $jumlah,
            "waktu" => $waktu,
        );
...
<html lang="en">
  <head>
    <title>Majestic Pet Care - Detail Layanan</title>
  ...
  <body>
    ...
    <section class="kontent">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="foto_layanan/<?php echo $detail["foto_layanan"]; ?>" alt="" class="img-responsive">
                </div>
                <div class="col-md-6">
                    <h2><?php echo $detail["nama_layanan"] ?></h2>           
                    <p><?php echo $detail["deskripsi_layanan"]; ?></p>
                    <h4>Rp. <?php echo number_format($detail["harga_layanan"]); ?></h4>
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="waktu" id="waktu" style="width: 200px;">
                                <?php
                                // Loop to generate time slots from 09:00 to 20:00
                                for ($i = 9; $i <= 20; $i+=1) {
                        ...
                        <div class="input-group-btn">
                            ...
                            <a href="services.php" class="btn btn-default">Kembali</a>
                        </div>
                    </form>
                    <?php
                    if (isset($_POST["beli"])) {
